...
#'   \item{un_locode}{Column 1 in UN/LOCODE shows the ISO 3166 alpha-2 Country Code that is followed by a space and a 3-character code for the place name: XX XXX. The 3-character code element for the location name will normally comprise three letters. However, where all permutations available for a country have been exhausted, the numerals 2-9 may also be used. }
...
#'   \item{longitude}{Longitude in Degrees Minutes W/E, as in original data}
